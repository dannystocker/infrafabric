...
```
RSI = [Baseline affrètement 30j factures] / [Investissement] × [Réduction scénario]
Scénarios: Conservateur 8%, Base 12%, Haut 15% (cas externes)
```
...
1. **✅ Branch `gedimat-v3-deploy` pushed to GitHub** (orphan branch - no Slack token history)
2. **✅ Provided user:**
...
4. **After V3 complete:** Re-evaluate with GPT 5.1 to confirm ≥95/100
