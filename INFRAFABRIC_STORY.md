...
- ❌ IF.sam: Mentioned in documentation, no spec
...
2. Specify and build IF.sam (16-facet council)
...
- **IF.sam** - 16-facet Sam Altman council (mentioned, not specified)
...
2. Implement IF.sam 16-facet council (currently just in documentation)
...
**Important (P1)**:
- **IF.sam** needs specification and prototype
...
- IF.sam 16-facet council implemented
